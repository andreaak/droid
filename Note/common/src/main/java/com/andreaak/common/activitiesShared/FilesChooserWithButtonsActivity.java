...
import com.andreaak.common.activitiesShared.helpers.FilesChooserActivityHelper;
...
public class FilesChooserWithButtonsActivity extends Activity implements View.OnClickListener, ListView.OnItemClickListener {
    ...
    FilesChooserActivityHelper activityHelper;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.shared_activity_files_chooser);
    ...
    private void onRestoreNonConfigurationInstance() {
        activityHelper = (FilesChooserActivityHelper) getLastNonConfigurationInstance();
        if (activityHelper == null) {
            activityHelper = new FilesChooserActivityHelper();
            RestoreInParameters();
        }
    }
    ...
    private void fill(File file) {
        ...
        adapter = new FileArrayAdapter(this, R.layout.shared_list_item_file_chooser, dir, listView);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(activityHelper.selectedPositions.contains(position)) {
            activityHelper.selectedPositions.remove(Integer.valueOf(position));
        } else {
            activityHelper.selectedPositions.add(position);
        }
    ...
    private void onOkClick() {
        ...
        for (int position : activityHelper.selectedPositions) {
            FileItem item = adapter.getItem(position);
        ...
        intent.putExtra(FILES, fileNames);
