...
import com.andreaak.cards.dataBase.FindNoteArrayAdapter;
import com.andreaak.cards.dataBase.FindNoteItem;
...
public class NoteFindActivity extends ListActivity {
    ...
    private void onRestoreNonConfigurationInstance() {
        ...
        if (helper == null) {
            ...
            if (!helper.openDatabase()) {
                Utils.showText(this, com.andreaak.cards.R.string.db_fault);
                finishWithFault();
                return;
            }
        }
    ...
    private void fill(String text) {
        ...
        adapter = new FindNoteArrayAdapter(NoteFindActivity.this, com.andreaak.cards.R.layout.activity_note_find, dir);
